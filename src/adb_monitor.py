...
for USB relay connectivity. Works with SCAN Mobile which has the
gnirehtet VPN service built-in.
...
class ADBMonitor(DeviceMonitor):
    ...
    def _on_device_found(self, device_id: str):
        ...
        # Start USB relay on device (SCAN Mobile has gnirehtet VPN built-in)
    ...
    def _start_usb_relay_on_device(self, device_id: str):
        """Start USB relay VPN on the device."""
